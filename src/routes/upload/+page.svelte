<script lang="ts">
	...
	import { createComposition } from '$lib/firebase/db';
	...
	async function handleSubmit() {
		...
		try {
			...
			errorMessage = 'Failed to upload. Please check your connection and try again.';
		} finally {
			isSubmitting = false;
		}
	}
...
<svelte:head>
	<title>Upload Composition - Share Your Tabla Pieces</title>
</svelte:head>
...
<main class="min-h-screen bg-gradient-to-b from-amber-50 to-orange-100 font-sans">
	<div class="container mx-auto px-4 py-8 max-w-2xl">
		...
		<h1 class="text-4xl font-bold text-amber-900 mb-8">Upload Composition</h1>
